...
describe('Property 36: Browser crash recovery', () => {
  ...
  it('should restart browser after close and allow new operations', async () => {
    await fc.assert(
  ...
  it('should clear page pool after restart', async () => {
    await fc.assert(
      fc.asyncProperty(fc.integer({ min: 1, max: 3 }), async (numPages) => {
  ...
  it('should handle restart when browser is not running', async () => {
    await fc.assert(
  ...
  it('should handle multiple restart calls', async () => {
    await fc.assert(
  ...
  it('should detect disconnection and clear state', async () => {
    await fc.assert(
      fc.asyncProperty(fc.integer({ min: 1, max: 3 }), async (numPages) => {
        // Get pages
        const pages = [];
