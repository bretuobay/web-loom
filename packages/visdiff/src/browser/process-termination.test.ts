...
describe('Property 35: Process termination on exit', () => {
  it(
    'should terminate browser process when close is called',
    async () => {
      await fc.assert(
  ...
  it(
    'should handle close when browser is not running',
    async () => {
      await fc.assert(
  ...
  it(
    'should close all pooled pages when closing browser',
    async () => {
      await fc.assert(
  ...
  it(
    'should allow multiple close calls without error',
    async () => {
      await fc.assert(
  ...
  it(
    'should terminate browser even with active pages',
    async () => {
      await fc.assert(
