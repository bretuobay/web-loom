...
export class Command {
    ...
    _canExecute$; // Derived from constructor arg
    _executeError$ = new BehaviorSubject(null);
    executeError$ = this._executeError$.asObservable();
    _executeFn;
     ...
     */
    constructor(executeFn, canExecuteFn) {
        ...
        if (canExecuteFn === undefined) {
            ...
            console.warn("canExecuteFn as a function for Command's constructor is deprecated. Use an Observable<boolean> for reactive canExecute$.");
            ...
            throw new Error('canExecuteFn must be an Observable<boolean> or a function returning boolean/Observable<boolean>.');
        }
    }
    /**
