...
const sampleProducts: Product[] = [
  ...
  { id: 'P102', name: 'Wireless Mouse', category: 'Electronics', price: 25.5, inStock: true, rating: 4 },
  { id: 'P103', name: 'The Great Novel', category: 'Books', price: 15.0, inStock: false, rating: 5 },
  { id: 'P104', name: 'T-Shirt Basic', category: 'Clothing', price: 19.99, inStock: true, rating: 3 },
  { id: 'P105', name: 'Coffee Maker Deluxe', category: 'Home Goods', price: 79.0, inStock: true, rating: 4 },
  { id: 'P106', name: 'Advanced JavaScript', category: 'Books', price: 45.0, inStock: true, rating: 5 },
  { id: 'P107', name: 'Gaming Keyboard', category: 'Electronics', price: 120.0, inStock: false, rating: 4 },
  ...
  { id: 'P111', name: 'Bluetooth Headphones', category: 'Electronics', price: 89.9, inStock: true, rating: 5 },
  { id: 'P112', name: 'Running Shoes', category: 'Clothing', price: 75.0, inStock: false, rating: 4 },
  { id: 'P113', name: 'Desk Lamp LED', category: 'Home Goods', price: 32.0, inStock: true, rating: 3 },
  { id: 'P114', name: 'Classic Poetry', category: 'Books', price: 12.5, inStock: true, rating: 4 },
  { id: 'P115', name: 'Webcam HD', category: 'Electronics', price: 55.0, inStock: true, rating: 4 },
];
...
export async function runProductListExample() {
  ...
  productsVM.updateItem('id', 'P101', { price: 1150.0 });
  await new Promise((resolve) => setTimeout(resolve, 50));
