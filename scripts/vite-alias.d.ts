...
export declare const webLoomPackages: readonly [
  '@web-loom/mvvm-core',
 ...
 */
export declare function createAliases(
  dirname: string,
 ...
 */
export declare function createAliasArray(
  dirname: string,
 ...
 */
export declare const libraryExternals: readonly [
  'react',
  'react-dom',
  'react/jsx-runtime',
  'vue',
