...
topicTitle: 'Framework-Agnostic Design Principles and Patterns'
topicSlug: '03-framework-agnostic-design-principles-and-patterns'
nextTitle: 'Core Contracts and Interfaces: Building the Plugin Foundation'
nextSlug: '/04-core-contracts-and-interfaces'
---
