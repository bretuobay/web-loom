...
topicTitle: 'Table of Contents'
topicSlug: '00-table-of-contents'
nextTitle: 'Foundations of Plugin Architecture'
nextSlug: '/docs/01-foundations-of-plugin-architecture'
---
...
14. Performance Optimisation and Bundle Management
