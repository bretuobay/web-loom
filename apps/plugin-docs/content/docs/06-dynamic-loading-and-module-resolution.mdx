...
topicTitle: 'Dynamic Loading and Module Resolution Strategies'
topicSlug: '06-dynamic-loading-and-module-resolution-strategies'
nextTitle: 'Plugin SDK Design'
nextSlug: '/07-plugin-sdk-design'
---
