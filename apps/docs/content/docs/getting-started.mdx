...
- Framework adapters (`@web-loom/forms-react`, `@web-loom/media-vue`, …, published from the [`web-loom-extensions`](https://github.com/bretuobay/web-loom-extensions) repo) — thin wrappers, typically under 200 lines
