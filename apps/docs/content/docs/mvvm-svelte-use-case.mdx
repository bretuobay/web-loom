...
summary: 'How to wire Web Loom ViewModels into Svelte 5 components using reactive state and onMount/onDestroy lifecycle hooks. @web-loom/signals-core signals subscribe directly in Svelte lifecycle functions.'
...
- **Subscribe to ViewModel** — `onMount(() => observe(vm.data$, ...))`
