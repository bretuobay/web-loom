...
## 1. Documentation gaps — presented RxJS as the _current_ pattern
...
- `apps/plugin-docs/content/docs/{03-framework-agnostic-design-principles,13-dashboard-analytics-plugins}.mdx`, `.../plugin_architecture_notes/kibana/*.md` — plugin-docs referencing an external framework's (Kibana's) architecture for comparison; unlikely to be about _our_ RxJS usage.
